...
Enables or disables the creation of an `.xml` file with the `XMLDoc` generated from the source files' `PHPDoc`. The default value is `false` in order not to generate the XML documentation file.
